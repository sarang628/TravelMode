...
public abstract class Hilt_TravelModeMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TravelModeMapFragment() {
    super();
  }

  Hilt_TravelModeMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TravelModeMapFragment_GeneratedInjector) this.generatedComponent()).injectTravelModeMapFragment(UnsafeCasts.<TravelModeMapFragment>unsafeCast(this));
    }
  }
